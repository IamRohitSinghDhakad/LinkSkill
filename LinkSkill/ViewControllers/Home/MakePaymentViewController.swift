...
class MakePaymentViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        guard let url = URL(string: "https://ambitious.in.net/Shubham/linkskill/api/card_view?job_id=\(strJobId)&currency=\(curreny)&amount=\(self.strTotalPayment)&user_id=\(objAppShareData.UserDetail.strUserId ?? "")") else {
            print("Invalid URL")
            return
        }
